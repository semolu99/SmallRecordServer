package ConSilkTea.SmallRecordServer.member.dto
...
data class MemberDtoRequest(
    ...
    @field:Pattern(
        ...
        message = "영문, 숫자, 특수 문자를 포함한 8~20자리로 입력 해주세요"
    )
    ...
    @field:Pattern(
        ...
        message = "날짜 형식(YYYY-MM-DD)을 확인 해주세요."
    )
    @JsonProperty("birthDate")
    private val _birthDate: String?,

    @field:NotBlank
    @field:ValidEnum(enumClass = Gender::class, message = "MAN 이나 WOMEN 중 하나를 선택 해주세요.")
    @JsonProperty("gender")
